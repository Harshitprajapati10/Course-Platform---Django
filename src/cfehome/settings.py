...
EMAIL_ADDRESS = "premiumhofficial@gmail.com"
EMAIL_HOST_USER = config("EMAIL_HOST_USER", cast=str, default=None)
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD", cast=str, default=None)
EMAIL_USE_TLS = config("EMAIL_USE_TLS", cast=bool, default=True)  # Use EMAIL_PORT 587 for TLS

ADMIN_USER_NAME=config("ADMIN_USER_NAME", default="Harshit")
...
SECRET_KEY = 'django-insecure-l#@!xfp(e!4870e4fcaerjy=d$ncxd0_8uy_vc#-#agiqvt6*u'
...
NPM_BIN_PATH = r'C:\Program Files\nodejs\npm.cmd' # path of local npm installed
