from .models import Course, PublishStatus,Lesson, AccessRequirement

def get_publish_courses():
    return Course.objects.filter(status = PublishStatus.PUBLISHED) # render if course is published
